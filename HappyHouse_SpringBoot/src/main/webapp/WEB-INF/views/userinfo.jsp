				...
				<c:if test="${!empty searchUser }">
					<div>
						<form id="contactForm" data-sb-form-api-token="API_TOKEN"
							...
							<!-- 수정 버튼-->
							<input formaction="main?action=update" id="checkButton" class="submitButton" type="submit"
								value="저장✓" />
							<!-- 삭제 버튼-->
							<input formaction="main?action=delete" id="deleteButton" class="submitButton" type="submit"
