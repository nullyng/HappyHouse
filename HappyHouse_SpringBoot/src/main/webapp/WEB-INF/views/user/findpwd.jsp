  ...
  <body id="page-top">
    ...
    <div class="main-content">
      <div class="main-content-signup">
        <div class="container">
          <!-- 회원가입 영역 상단 -->
          <h2 class="page-section-heading text-left text-black-50 mb-0">비밀번호 찾기</h2>
          <!-- 회원가입 영역 폼 -->
          <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7">
              <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post" action="user/findpass">
                <!-- 아이디 입력-->
                ...
                <div class="form-floating mb-3">
                  ...
                  <label for="phone" class="text-black-50">이름</label>
                ...
                <!-- 등록 버튼-->
                <input id="submitButton" class="submitButton" type="submit" value="비밀번호 찾기✓" />
              </form>
            </div>
          </div>
        </div>
